...
Knc_TS2 <- Knc_Samples %>% filter(Section == "TS2") #& Facies_ID == "Mp")
Knc_TS3 <- Knc_Samples %>% filter(Section == "TS3")
Knc_TS4 <- Knc_Samples %>% filter(Section == "TS4") 
Knc_TS5 <- Knc_Samples %>% filter(Section == "TS5") 
